...
Interview-focused preparation for data science roles — behavioral screens, technical problem patterns, and the soft skills that decide whether strong candidates get offers. This section starts with how interviews actually work, then builds toward the technical rounds.
...
- [Probability problems (Hard)](./lesson-5-probability-problems-hard) — 7 advanced compute questions
- [Statistics](./lesson-6-statistics) — LLN, CLT, hypothesis tests, CIs, MLE + explorers
...
- [SQL problems (Easy)](./lesson-13-sql-problems-easy) — Ch.8 query drills + design write-ups
- [SQL problems (Medium)](./lesson-14-sql-problems-medium) — retention, concurrency, rolling metrics + design
- [Coding interviews](./lesson-15-coding-interviews) — approach, Big-O, ML complexity sketch
- [Data structures](./lesson-16-data-structures) — arrays through graphs + coding drills
- [Algorithms](./lesson-17-algorithms) — recursion, greedy, knapsack DP + simulator
- [Sorting algorithms](./lesson-21-sorting) — 6 sorts, tradeoffs, grid step animations
