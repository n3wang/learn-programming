...
export class PauseScene extends Phaser.Scene {
  ...
  create() {
    ...
    createButton(this, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, 260, 40, 'Resume', () => {
      fight.setPaused(false)
    })
    createButton(this, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 60, 260, 40, 'Restart', () => {
      fight.restartMatch()
    })
    createButton(this, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 120, 260, 40, 'Change Fighters', () => {
      fight.goToSelect()
    })
  }
}
