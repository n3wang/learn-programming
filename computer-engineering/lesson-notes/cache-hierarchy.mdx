...
import CacheHierarchyEn from './cache-hierarchy.en.mdx';
import CacheHierarchyZh from './cache-hierarchy.zh.mdx';
import SiteLanguageToggle from '@site/src/components/i18n/SiteLanguageToggle';
import { useSiteLanguage } from '@site/src/components/i18n/useSiteLanguage';
...
export default function CacheHierarchyPage() {
  ...
  return (
    <>
      <SiteLanguageToggle lang={lang} setLang={setLang} compact />
      {isZh ? <CacheHierarchyZh /> : <CacheHierarchyEn />}
    </>
  );
}
---
