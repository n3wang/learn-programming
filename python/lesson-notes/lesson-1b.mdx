...
3. Write down the instructions needed to create this graphic in the editor (local Python / Thonny).
4. After completion, share a screenshot or your local turtle file(https://forms.gle/Xcznm1uY195zkN3H9).
