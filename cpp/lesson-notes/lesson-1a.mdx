...
Recreate the program from the starter (or wipe it and start from zero). Hidden tests run your code with different inputs and check the printed result.

<CodingExam
  title="Temperature converter"
  lang="c++"
  prompt="Read a Celsius temperature from the user and print the Fahrenheit equivalent using F = (C × 9/5) + 32. The sample log shows one successful run; your code must also pass other temperatures."
